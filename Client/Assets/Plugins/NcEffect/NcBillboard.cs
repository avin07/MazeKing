...
{
	// Attribute ------------------------------------------------------------------------
	public  	Transform       m_focusTransform;
	...
	void Update()
	{
		...
		Transform focusTransform = m_focusTransform;
...
//  			vecUp		= m_qOiginal * Vector3.up;
			vecUp		= transform.up;
		else vecUp		= focusTransform.rotation * Vector3.up;

		if (m_bCameraLookAt)
			transform.LookAt(focusTransform,	vecUp);
		else transform.LookAt(transform.position + focusTransform.rotation * Vector3.back, vecUp);
