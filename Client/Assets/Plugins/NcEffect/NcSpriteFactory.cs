...
// 		m_bNeedRebuild = true;
	...
	{
//   		Debuger.Log("GetSpriteUvRect() - m_SpriteList.Count = " + m_SpriteList.Count + ", nStriteIndex = " + nStriteIndex + ", nFrameIndex = " + nFrameIndex);
...
//				UpdateUvScale(nNodeIndex, transform);
	...
	void CreateEffectObject()
	{
		...
		if (m_bShowEffect == false)
			return;
		DestroyEffectObject();
// 		Debuger.Log("CreateEffectObject() - new = " + ncSpriteNode.m_EffectPrefab);
...
// 			createEffect.transform.Rotate(ncSpriteNode.m_EffectRot, Space.Self);
	...
	{
//  		Debuger.Log("DestroyEffectObject - " + m_CurrentEffect);
...
// 		Debuger.Log("CreateSoundObject");
	...
	{
// 		Debuger.Log("OnChangingSprite() - nOldNodeIndex = " + nOldNodeIndex + ", nNewNodeIndex = " + nNewNodeIndex);
	...
	{
// 		Debuger.Log("OnAnimationChangingFrame() - nOldIndex = " + nOldIndex + ", nNewIndex = " + nNewIndex + ", nLoopCount = " + nLoopCount + ", m_nCurrentIndex = " + m_nCurrentIndex);
...
// 		m_fFps	*= fSpeedRate;
	...
	{
// 		Debuger.Log(ncSpriteFrameInfo.m_FrameUvOffset);
...
//  			Debuger.Log(meshFilter.mesh.vertices[n]);
	}
