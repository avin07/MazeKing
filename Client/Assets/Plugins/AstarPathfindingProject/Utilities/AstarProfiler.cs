...
namespace Pathfinding {
	public class AstarProfiler
	{
		...
		public static void EndFastProfile(int tag)
		{
			...
			{
				Debuger.LogError("Can only end profiling for a tag which has already been started (tag was " + tag + ")");
				return;
			}*/
