        ...
        void InitNode(RaidNodeStruct nodeConfig, bool bNewRoom)
        {
                ...
                if (elemCfg != null)
                {
                        ...
                        if (node.elemCfg != null)
                        {
                                ...
                                {
                                        node.gameObject.name = "DoorNode_" + node.id + CommonString.underscoreStr + direct.ToString() + CommonString.underscoreStr + subIndex + CommonString.underscoreStr + linkIndex;
