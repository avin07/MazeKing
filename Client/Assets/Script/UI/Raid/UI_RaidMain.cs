                ...
                for (int i = 0; i < taskCfg.target_id.Count; i++)
                {
                        ...
                        if (max > 0)
                        {
                                if (dict.ContainsKey(id))
                                {
                                        ...
                                        {
                                                bFinish = false;
                                                paramArray[i] = dict[id] + CommonString.divideStr + max;
                                        }
                                        else
                                        {
                                                paramArray[i] = max + CommonString.divideStr + max;
                                        }
                                }
                                else
                                {
                                        paramArray[i] = CommonString.zeroStr + CommonString.divideStr + max;
                        ...
                        else
                        {
                                ...
                                {
                                        paramArray[i] = CommonString.zeroStr;
                                }
                        }
                }
