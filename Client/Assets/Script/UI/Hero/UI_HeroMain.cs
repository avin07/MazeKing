...
public class UI_HeroMain : UIBehaviour
{
        ...
        void RefreshAttr()
        {
                ...
                if (level != max_level)
                {
                        ...
                        FindComponent<Text>(group, "exp_bar/exp_num").text = now_exp + CommonString.divideStr + next_level_need_exp;
                ...
                string career_url = CharacterManager.GetInst().GetCareerIcon(m_select_hero.GetPropertyInt("career"));
                ...
                if (ca_cfg != null)
                {
                        ...
                        switch (achieve_type)
                        {
                                ...
                                case ACHIEVE_TYPE.SKILL_SPECIFY_UP:
                                        if (!target_para_list.Contains(CommonString.commaStr))
                                        {
                        ...
                        if (!m_select_hero.isAchievementGet(achievement_id))
                        {
                                ...
                                FindComponent<Text>(AchievementTip, "exp_bar/exp_num").text = now_exp + CommonString.divideStr + max_exp;
