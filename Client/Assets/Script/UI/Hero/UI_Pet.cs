...
public class UI_Pet : UI_ScrollRectHelp
{
        ...
        void UpdatePet(Pet pet, GameObject go)
        {
            ...
            GetText(go, "maxlevel").text = CommonString.divideStr + pet.GetPropertyString("max_level");
            ...
            ResourceManager.GetInst().LoadIconSpriteSyn(CharacterManager.GetInst().GetCareerIcon(pet.GetPropertyInt("career")), GetImage(go, "careersys_icon").transform);
        ...
        //    ResourceManager.GetInst().LoadIconSprite(CharacterManager.GetInst().GetCareerIcon(cc.GetPropInt("career")), GetImage(go, "career_icon").transform);
