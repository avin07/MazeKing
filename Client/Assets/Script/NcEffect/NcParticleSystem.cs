...
//		m_fStartSpeedRate		= 1;
	...
	public static void Ng_SetProperty(object srcObj, string fieldName, object newValue)
	{
		...
		else Debuger.LogWarning(fieldName + " could not be write.");
	}
	...
	public static object Ng_GetProperty(object srcObj, string fieldName)
	{
		...
		} else Debuger.LogWarning(fieldName + " could not be read.");
		return ret;
	}
	...
	public static void SetPropertyValue(SerializedObject serObj, string propertyName, object value, bool bUpdate)
	{
		...
		if (sp == null)
		{
			Debuger.LogError("SetPropertyValue error - " + propertyName);
			return;
		}
		...
		if (bUpdate)
		{
 			...
 			{
//				Debuger.LogWarning("Failed - ApplyModifiedProperties " + propertyName);		// dup
			}
		}
	}
...
// 			default: Debuger.Log("Undefile propertyType - SetPropertyValue " + sp.name); break;
		}
	}
