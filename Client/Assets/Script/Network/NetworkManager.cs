    ...
    //获取平台id的地址
     public static string PlatformUrl = "http://api-xj.iahgames.com/key?key=DLK&domain=";
        ...
        public bool ServerChannalSwitch(string address, int port)
        {
                ...
                if (!string.IsNullOrEmpty(m_KeyInfo.Trim()) && m_KeyInfo.ToLower() != "null" && m_KeyInfo.Contains(CommonString.commaStr))
                {
                ...
                else
                {
                        ...
                        m_KeyInfo += ",1,1," + address + CommonString.commaStr + port + ",pkServer";
                }
                ...
                {
                        string tmpKey4PKserver = infos[0] + CommonString.commaStr + infos[1] + CommonString.commaStr + infos[2] + CommonString.commaStr + address + CommonString.commaStr + port + CommonString.commaStr + infos[5];
