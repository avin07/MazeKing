...
{
    public const string InteractiveTag = "Interactive";
    ...
    public int id;  //pos.x * 100 + pos.y为id
        ...
        public float PlayAnim(NODE_STATE state, bool bLoop = false)
        {
                ...
                if (!string.IsNullOrEmpty(animName) && !animName.Equals("0"))
                {
                        if (animName == "idle_001")
                        {
                                bLoop = true;
                        }
        ...
        public void InitElemObj()
        {
                ...
                if (elemCfg.IsCharacter())
                {
                        ...
                        GameUtility.ObjPlayAnim(elemObj, "idle_001", true);
                }
                else
                {
