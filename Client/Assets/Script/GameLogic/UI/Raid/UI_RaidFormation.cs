...
//                 }
        ...
        {                                
                ...
                for (int i = 0; i < petlist.Count; i++)
                {
                        ...
                        m_TeamCount.text = exist_num + "/" + m_nMaxTeamCount;
                }
...
/*                SetPressure(pet.FighterProp.Pressure, go);*/
                ...
                ResourceManager.GetInst().LoadIconSpriteSyn(HeroManager.GetInst().GetCareerIcon(pet.GetPropertyInt("career")), GetImage(go, "career_icon").transform);
        }
        ...
        void RemovePetFromFormation(FormationUnitBehav fub, int idx)
        {
                ...
                m_TeamCount.text = m_UnitDict.Count + "/" + m_nMaxTeamCount;
                CheckIconState();
        ...
        string GetItemList()
        {
                ...
                {
                        itemlist += param.Key + "&" + param.Value + " | ";
                }
