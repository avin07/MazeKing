...
public class UI_SkillUpgrade : UIBehaviour
{
        ...
        public void ChooseHero(Pet pet)
        {
                ...
                string icon = ModelResourceManager.GetInst().GetIconRes(m_SelectHero.m_CharacterCfg.model_id);
                ...
                CareerConfigHold careerCfg = HeroManager.GetInst().GetCareerCfg(m_SelectHero.m_CharacterCfg.career);
                if (careerCfg != null)
                {
