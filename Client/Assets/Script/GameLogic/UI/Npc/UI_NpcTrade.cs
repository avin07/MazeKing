...
//                 }
        ...
        bool AddDropObjToBag(DropObject dObj, string targetPrefix, GameObject parent, ref Dictionary<GameObject, DropObject> dict, string objname = "")
        {
                ...
                {
                        case "MyBag":
                                itemObj = CloneElement(m_MyBagItem, targetPrefix + "_" + dObj.id);
                        ...
                        case "NpcBag":
                                ...
                                break;
                        case"MySell":
                                itemObj = CloneElement(m_MySellItem, targetPrefix + "_" + dObj.id);
                                itemObj.transform.SetParent(parent.transform);
                                break;
                        case "NpcSell":
                                itemObj = CloneElement(m_NpcSellItem, targetPrefix + "_" + dObj.id);
                                itemObj.transform.SetParent(parent.transform);
                                break;
                }
                if (itemObj != null)
        ...
        int GetValue(DropObject dObj, bool bNpc)
        {
                if (m_TradeCfg != null)
                {
                        ...
                        string tmp = dObj.nType + "," + dObj.GetSubType().ToString() + ",";
