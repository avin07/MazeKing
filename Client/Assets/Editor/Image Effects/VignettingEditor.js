...
{	
  ...
  var intensityX : SerializedProperty; // intensity == 0 disables pre pass (optimization)
  ...
  var luminanceDependency : SerializedProperty;
    ...
    intensityX = serObj.FindProperty ("intensityX");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (intensityX, new GUIContent("Vignetting_X"));    
