...
namespace Pathfinding.Voxels {
	...
	public class Utility {
		...
		public static void EndTimer (string label) {
			Debuger.Log (label+", process took "+ToMillis(Time.realtimeSinceStartup-lastStartTime)+"ms to complete");
		}	
		...
		public static void EndTimerAdditive (string label, bool log) {
			...
			if (log) {
				Debuger.Log (label+", process took "+ToMillis(additiveTimer)+"ms to complete");
			}
