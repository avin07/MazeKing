...
class Vignetting /* And Chromatic Aberration */ extends PostEffectsBase {
    ...
    public var intensityX: float = 2f; // intensity == 0 disables pre pass (optimization)
	...
	public var vignetteMaterial : Material;
	
	public var separableBlurShader : Shader;
	public var separableBlurMaterial : Material;	
	
	public var chromAberrationShader : Shader;
	public var chromAberrationMaterial : Material;
	...
	function OnRenderImage (source : RenderTexture, destination : RenderTexture) {	
		...
		if (doPrepass) {
            ...
            vignetteMaterial.SetFloat ("_IntensityX", intensityX); 		// intensity for vignette
